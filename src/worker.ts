    ...
    switch (msg.kind) {
      case "customRequest": {
        ...
        if (params.requestName == "chunkGenerate") {
          ...
          if (!params.requestMessage || params.requestMessage === "undefined") { //simple solution to solve undefined by now
            ...
            try {
              genConfig = JSON.parse(params.requestMessage) as GenerationConfig;
            } catch (error) {
